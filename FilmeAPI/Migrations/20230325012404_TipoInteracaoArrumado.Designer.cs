...
namespace FilmeAPI.Migrations
{
    ...
    [Migration("20230325012404_TipoInteracaoArrumado")]
    partial class TipoInteracaoArrumado
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FilmeAPI.Models.Interacao", b =>
                {
                    ...
                    b.Property<int>("tipoInteracaoid")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FilmeAPI.Models.TipoInteracao", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FilmeAPI.Models.Interacao", b =>
                {
                    ...
                    b.HasOne("FilmeAPI.Models.TipoInteracao", "tipoInteracao")
                        .WithMany()
                        .HasForeignKey("tipoInteracaoid")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("publicacao");

                    b.Navigation("tipoInteracao");
